...
gj.widget = function () {
        ...
        parseDate: function (a, b, c) {
            ...
            if (a && "string" == typeof a) {
                if (/^\d+$/.test(a)) {
                    ...
                    for (e = a.split(/[\s,-\.\/\/\:]+/), f = b.split(/[\s,-\.\/\/\:]+/), d = 0; d < f.length; d += 1) {
        ...
        formatDate: function (a, b, c) {
            ...
            for (h = h.splice(1, h.length - 2), i = 0; i < g.length; i += 1) {
                switch (d = h[i] || "", g[i]) {
                    case "s":
                        f += a.getSeconds() + d;
                        break;
        ...
        addClasses: function (a, b) {
            var c, d;
            if (b) {
                for (d = b.split(" "), c = 0; c < d.length; c += 1) {
                    a.classList.add(d[c]);
                }
            }
        },
    ...
    function (a) {
        ...
        eventsParser: function (events) {
            ...
            for (list = events.split(","), i = 0; i < list.length; i += 1) {
        ...
        useHtmlDataSource: function (a, b) {
            ...
            for (c = 0; c < h.length; c += 1) {
                for (e = $(h[c]).find("td"), f = {}, d = 0; d < e.length; d += 1) {
        ...
        autoGenerateColumns: function (a, b) {
            ...
            if (g.columns = [], b.length > 0) {
                for (c = Object.getOwnPropertyNames(b[0]), f = 0; f < c.length; f += 1) {
        ...
        loadData: function (a) {
            var b, c, d, e, f, g, h, i;
            for (b = a.data(), c = a.getAll(), gj.grid.events.dataBinding(a, c), e = c.length, gj.grid.methods.stopLoading(a), b.autoGenerateColumns && gj.grid.methods.autoGenerateColumns(a, c), g = a.children("tbody"), "checkbox" === b.selectionMethod && "multiple" === b.selectionType && a.find('thead input[data-role="selectAll"]').prop("checked", !1), g.children("tr").not('[data-role="row"]').remove(), 0 === e && (g.empty(), gj.grid.methods.appendEmptyRow(a)), h = g.children("tr"), f = h.length, d = 0; d < f; d += 1) {
                if (!(d < e)) {
        ...
        renderRow: function (a, b, c, d) {
            var e, f, g, h, i;
            for (h = a.data(), b && 0 !== b.length ? (i = "update", b.removeClass(h.style.content.rowSelected).removeAttr("data-selected").off("click")) : (i = "create", b = $('<tr data-role="row"/>'), a.children("tbody").append(b)), e = gj.grid.methods.getId(c, h.primaryKey, d + 1), b.attr("data-position", d + 1), "checkbox" !== h.selectionMethod && b.on("click", gj.grid.methods.createRowClickHandler(a, e)), g = 0; g < h.columns.length; g += 1) {
        ...
        getRecVPosById: function (a, b) {
            var c, d = b,
                e = a.data();
            if (e.primaryKey) {
                for (c = 0; c < e.dataSource.length; c += 1) {
        ...
        countVisibleColumns: function (a) {
            var b, c, d;
            for (b = a.data().columns, c = 0, d = 0; d < b.length; d += 1) {
                !0 !== b[d].hidden && (c += 1);
            }
            return c
        },
    ...
    function (a) {
        ...
        private: {
            ...
            refresh: function (a) {
                ...
                for (a.children("tbody").height() < gj.grid.plugins.fixedHeader.private.getRowsHeight(a) ? d.css("width", e.outerWidth() + gj.grid.plugins.fixedHeader.private.getScrollBarWidth() + (navigator.userAgent.toLowerCase().indexOf("firefox") > -1 ? 1 : 0)) : d.css("width", e.outerWidth()), b = 0; b < g.length; b += 1) {
        ...
        configure: function (a) {
            ...
            $.extend(!0, a, gj.grid.plugins.expandCollapseRows.public), void 0 !== c.detailTemplate && (b = {
                ...
                if (f.keepExpandedRows && $.isArray(f.expandedRows)) {
                    for (b = 0; b < f.expandedRows.length; b += 1) {
                ...
                if (c.editor) {
                    if ((gj.grid.plugins.inlineEditing.private.updateOtherCells(a, c.mode), e = b.find('div[data-role="display"]').hide(), f = b.find('div[data-role="edit"]').show(), 0 === f.length && (f = $('<div data-role="edit" />'), b.append(f)), h = d[c.editField || c.field], g = f.find("input, select, textarea").first(), g.length)) {
                        ...
                        if ("function" == typeof c.editor) {
                            ...
                            "dropdown" === c.type && gj.dropdown ? (g = $('<select type="text" width="100%"/>'), f.append(g), i.dataBound = function (a) {
                                var b = $(this).dropdown();
        ...
        private: {
            ...
            saveParams: function (a) {
                ...
                if (d.optimisticPersistence.sessionStorage) {
                    for (b = 0; b < d.optimisticPersistence.sessionStorage.length; b += 1) {
                ...
                if (d.optimisticPersistence.localStorage) {
                    for (e = {
                            optimisticPersistence: {}
                        }, b = 0; b < d.optimisticPersistence.localStorage.length; b += 1) {
        ...
        config: {
            ...
            materialicons: {
                icons: {
                    ffirst: '<i class="fa fa-fast-backward" aria-hidden="true"></i>',
        ...
        private: {
            init: function (a) {
                ...
                if ((d = a.data(), d.pager)) {
                    for (d.params[d.paramNames.page] || (d.params[d.paramNames.page] = 1), d.params[d.paramNames.limit] || (d.params[d.paramNames.limit] = d.pager.limit), gj.grid.plugins.pagination.private.localization(d), b = $('<tr data-role="pager"/>'), c = $("<th/>"), b.append(c), f = $('<div data-role="display" />').addClass(d.style.pager.panel).css({
                            ...
                            g.append(this)
                        }), e = a.find("tfoot [data-role]"), k = 0; k < e.length; k += 1) {
            ...
            reloadPager: function (a, b) {
                var c, d, e, f, g, h, i, j;
                if (h = a.data(), h.pager) {
                    for (c = 0 === b ? 0 : parseInt(h.params[h.paramNames.page], 10), d = parseInt(h.params[h.paramNames.limit], 10), e = Math.ceil(b / d), f = 0 === c ? 0 : d * (c - 1) + 1, g = f + d > b ? b : f + d - 1, i = a.find("TFOOT [data-role]"), j = 0; j < i.length; j += 1) {
        ...
        private: {
            orderColumns: function (a) {
                ...
                if (a.columns && a.columns.length) {
                    for (i = 0; i < a.columns.length; i += 1) {
                        b.push({
                            position: i,
            ...
            updateDetails: function (a) {
                var b, c, d, e, f, g, h, i, j;
                for (b = a.find('tbody > tr[data-role="row"]'), c = a.data(), d = 0; d < b.length; d += 1) {
                    for (f = $(b[d]), g = f.data("details"), e = 0; e < c.columns.length; e += 1) {
            ...
            createResizeHandle: function (a, b, c) {
                ...
                return function (e, f) {
                    ...
                    if ((m || (m = b.outerWidth()), o.left && (k = m + o.left, c.width = k, b.attr("width", k), h = b[0].cellIndex, j = b[0].parentElement.children[h + 1], l = parseInt($(j).attr("width"), 10) - o.left, j.setAttribute("width", l), d.resizableColumns))) {
                        for (i = a[0].tBodies[0].children, g = 0; g < i.length; g += 1) {
        ...
        private: {
            init: function (a) {
                ...
                for (a.data("rowReorderColumn") && (c = gj.grid.methods.getColumnPosition(a.data("columns"), a.data("rowReorderColumn"))), b = 0; b < e.length; b += 1) {
            ...
            createRowMouseDownHandler: function (a, b) {
                return function (c) {
                    var d, e, f = a.clone(),
                        g = a.data("columns");
                    for (a.addClass("gj-unselectable"), $("body").append(f), f.attr("data-role", "draggable-clone").css("cursor", "move"), f.children("thead").remove().children("tfoot").remove(), f.find('tbody tr:not([data-position="' + b.data("position") + '"])').remove(), e = f.find("tbody tr td"), d = 0; d < e.length; d += 1) {
                ...
                return function (c, d) {
                    $('table[data-role="draggable-clone"]').draggable("destroy").remove(), a.removeClass("gj-unselectable"), b.siblings('tr[data-role="row"]').each(function () {
                        ...
                        if (i.droppable("isOver", d)) {
                            for (j < k ? i.before(b) : i.after(b), l.records.splice(j - 1, 0, l.records.splice(k - 1, 1)[0]), c = i.parent().find('tr[data-role="row"]'), f = 0; f < c.length; f += 1) {
                                $(c[f]).attr("data-position", f + 1);
                            }
                            if (l.orderNumberField) {
                                for (f = 0; f < l.records.length; f += 1) {
        ...
        private: {
            init: function (a) {
                ...
                for (b = 0; b < e.columns.length; b += 1) {
        ...
        genAutoId: function (a, b) {
            ...
            for (c = 0; c < b.length; c += 1) {
                b[c][a.autoGenFieldName] = a.autoGenId += 1, b[c][a.childrenField] && b[c][a.childrenField].length && gj.tree.methods.genAutoId(a, b[c][a.childrenField]);
            }
        },
        loadData: function (a) {
            var b, c = a.data("records"),
                d = a.children("ul");
            for (gj.tree.events.dataBinding(a), d.off().empty(), b = 0; b < c.length; b += 1) {
        ...
        appendNode: function (a, b, c, d, e) {
            ...
            if ((g = $('<li data-id="' + l + '" data-role="node" />').addClass(k.style.item), $wrapper = $('<div data-role="wrapper" />'), $expander = $('<span data-role="expander" data-mode="close"></span>').addClass(k.style.expander), $display = $('<span data-role="display">' + c[k.textField] + "</span>"), hasChildren = void 0 !== c[k.hasChildrenField] && "true" === c[k.hasChildrenField].toString().toLowerCase(), disabled = void 0 !== c[k.disabledField] && "true" === c[k.disabledField].toString().toLowerCase(), k.indentation && $wrapper.append('<span data-role="spacer" style="width: ' + k.indentation * (d - 1) + 'px;"></span>'), disabled ? gj.tree.methods.disableNode(a, g) : ($expander.on("click", gj.tree.methods.expanderClickHandler(a)), $display.on("click", gj.tree.methods.displayClickHandler(a))), $wrapper.append($expander), $wrapper.append($display), g.append($wrapper), e ? b.find("li:eq(" + (e - 1) + ")").before(g) : b.append(g), k.imageCssClassField && c[k.imageCssClassField] ? (i = $('<span data-role="image"><span class="' + c[k.imageCssClassField] + '"></span></span>'), i.insertBefore($display)) : k.imageUrlField && c[k.imageUrlField] ? (i = $('<span data-role="image"></span>'), i.insertBefore($display), j = $('<img src="' + c[k.imageUrlField] + '"></img>'), j.attr("width", i.width()).attr("height", i.height()), i.append(j)) : k.imageHtmlField && c[k.imageHtmlField] && (i = $('<span data-role="image">' + c[k.imageHtmlField] + "</span>"), i.insertBefore($display)), c[k.childrenField] && c[k.childrenField].length || hasChildren)) {
                if (($expander.empty().append(k.icons.expand), h = $("<ul />").addClass(k.style.list).addClass("gj-hidden"), g.append(h), c[k.childrenField] && c[k.childrenField].length)) {
                    for (f = 0; f < c[k.childrenField].length; f += 1) {
        ...
        expand: function (a, b, c) {
            ...
            if (!1 !== gj.tree.events.expand(a, b, h) && i && i.length && (i.show(), f.attr("data-mode", "open"), f.empty().append(g.icons.collapse), c)) {
                for (d = b.find("ul>li"), e = 0; e < d.length; e += 1) {
        ...
        select: function (a, b, c) {
            ...
            if ("true" !== b.attr("data-selected") && !1 !== gj.tree.events.select(a, b, b.attr("data-id")) && (b.addClass(f.style.active).attr("data-selected", "true"), c)) {
                for (e = b.find("ul>li"), d = 0; d < e.length; d += 1) {
        ...
        getChildren: function (a, b, c) {
            var d, e, f = [],
                c = void 0 === c || c;
            for (e = c ? b.find("ul li") : b.find(">ul>li"), d = 0; d < e.length; d += 1) {
                f.push($(e[d]).data("id"));
            }
            return f
        },
            ...
            createNodeMouseMoveHandler: function (a, b, c) {
                return function (d) {
                    if (a.data("dragReady")) {
                        ...
                        }), f = c.parent(), g = c.offset().top, g -= parseInt(f.css("border-top-width"), 10) + parseInt(f.css("margin-top"), 10) + parseInt(f.css("padding-top"), 10), h = c.offset().left, h -= parseInt(f.css("border-left-width"), 10) + parseInt(f.css("margin-left"), 10) + parseInt(f.css("padding-left"), 10), h -= e.find('[data-role="indicator"]').outerWidth(!0), e.css({
                            position: "absolute",
                            top: g,
                            left: h,
                ...
                return function (a, b, c) {
                    ...
                    d.each(function () {
                        ...
                        if (b.droppable("isOver", c)) {
                            return (a = g.find('[data-role="indicator"]'), f.style.dropAsChildIcon ? a.addClass(f.style.dropAsChildIcon) : a.text("+"), h = !0, !1);
                        }
                ...
                return function (c, g) {
                    ...
                    $(this).draggable("destroy").remove(), d.each(function () {
                        ...
                        if (d.droppable("isOver", g)) {
                            return (i = d.closest("li"), j = b.parent("ul").parent("li"), c = i.children("ul"), 0 === c.length && (c = $("<ul />").addClass(f.style.list), i.append(c)), !1 !== gj.tree.plugins.dragAndDrop.events.nodeDrop(a, b.data("id"), i.data("id"), c.children("li").length + 1) && (c.append(b), h = a.getDataById(b.data("id")), gj.tree.methods.removeDataById(a, b.data("id"), f.records), k = a.getDataById(c.parent().data("id")), void 0 === k[f.childrenField] && (k[f.childrenField] = []), k[f.childrenField].push(h), gj.tree.plugins.dragAndDrop.private.refresh(a, b, i, j)), l = !0, !1);
                        }
                        d.droppable("destroy")
                    }), l || e.each(function () {
                        var c, d, e, k = $(this);
            ...
            createDoneHandler: function (a, b) {
                return function (c) {
                    ...
                    if ("string" == typeof c && JSON && (c = JSON.parse(c)), c && c.length) {
                        for (f = b.children("ul"), 0 === f.length && (f = $("<ul />").addClass(g.style.list), b.append(f)), d = 0; d < c.length; d += 1) {
                            a.addNode(c[d], f);
                        }
    ...
    function (a) {
        ...
        filter: function (a) {
            ...
            if (d.dataSource) {
                if ("string" == typeof d.dataSource[0]) {
                    for (b = 0; b < d.dataSource.length; b += 1) {
        ...
        getRecordByValue: function (a, b) {
            var c, d = a.data(),
                e = void 0;
            for (c = 0; c < d.records.length; c += 1) {
    ...
    function (a) {
        ...
        base: {
            ...
            icons: {
                ...
                previousMonth: '<i class="fa fa-backward" aria-hidden="true"></i>',
        ...
        createNavigation: function (a, b, c, d) {
            var e, f, g = $("<thead/>");
            for (f = $('<div role="navigator" />'), f.append($("<div>" + d.icons.previousMonth + "</div>").on("click", gj.datepicker.methods.prev(a, d))), f.append($('<div role="period"></div>').on("click", gj.datepicker.methods.changePeriod(a, d))), f.append($("<div>" + d.icons.nextMonth + "</div>").on("click", gj.datepicker.methods.next(a, d))), b.append(f), e = $('<tr role="week-days" />'), d.calendarWeeks && e.append("<th><div>&nbsp;</div></th>"), i = d.weekStartDay; i < gj.core.messages[d.locale].weekDaysMin.length; i += 1) {
                e.append("<th><div>" + gj.core.messages[d.locale].weekDaysMin[i] + "</div></th>");
            }
            for (i = 0; i < d.weekStartDay; i += 1) {
                e.append("<th><div>" + gj.core.messages[d.locale].weekDaysMin[i] + "</div></th>");
            }
        ...
        renderMonth: function (a, b, c) {
            ...
            for (s.off().empty(), gj.datepicker.methods.createNavigation(a, s, t, c), g = parseInt(b.attr("month"), 10), h = parseInt(b.attr("year"), 10), b.attr("type", "month"), b.find('div[role="period"]').text(gj.core.messages[c.locale].monthNames[g] + " " + h), i = new Array(31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31), h % 4 == 0 && 1900 != h && (i[1] = 29), j = i[g], k = (new Date(h, g, 1).getDay() + 7 - c.weekStartDay) % 7, d = 0, $row = $("<tr />"), n = gj.datepicker.methods.getPrevMonth(g, h), l = 1; l <= k; l += 1) {
                f = i[n.month] - k + l, r = new Date(n.year, n.month, f), c.calendarWeeks && 1 === l && $row.append('<td class="calendar-week"><div>' + gj.datepicker.methods.getWeekNumber(r) + "</div></td>"), p = $('<td class="other-month" />'), c.showOtherMonths && (q = $("<div>" + f + "</div>"), p.append(q), c.selectOtherMonths && gj.datepicker.methods.isSelectable(c, r) ? (p.addClass("gj-cursor-pointer").attr("day", f).attr("month", n.month).attr("year", n.year), q.on("click", gj.datepicker.methods.dayClickHandler(a, b, c, r)), q.on("mousedown", function (a) {
                    a.stopPropagation()
                })) : p.addClass("disabled")), $row.append(p), d += 1;
            }
            for (l > 1 && u.append($row), m = new Date(), l = 1; l <= j; l += 1) {
                r = new Date(h, g, l), 0 == d && ($row = $("<tr>"), c.calendarWeeks && $row.append('<td class="calendar-week"><div>' + gj.datepicker.methods.getWeekNumber(r) + "</div></td>")), p = $('<td day="' + l + '" month="' + g + '" year="' + h + '" />'), h === m.getFullYear() && g === m.getMonth() && l === m.getDate() ? p.addClass("today") : p.addClass("current-month"), q = $("<div>" + l + "</div>"), gj.datepicker.methods.isSelectable(c, r) ? (p.addClass("gj-cursor-pointer"), q.on("click", gj.datepicker.methods.dayClickHandler(a, b, c, r)), q.on("mousedown", function (a) {
                    a.stopPropagation()
                })) : p.addClass("disabled"), p.append(q), $row.append(p), 7 == (d += 1) && (u.append($row), d = 0);
            }
            for (o = gj.datepicker.methods.getNextMonth(g, h), l = 1; 0 != d; l += 1) {
        ...
        renderYear: function (a, b, c) {
            var d, e, f, g, h = b.find('>[role="body"]>table'),
                i = h.children("tbody");
            for (h.children("thead").hide(), d = parseInt(b.attr("year"), 10), b.attr("type", "year"), b.find('div[role="period"]').text(d), i.empty(), e = 0; e < 3; e += 1) {
                for ($row = $("<tr />"), f = 4 * e; f <= 4 * e + 3; f += 1) {
            ...
            if (e && b < e ? d = !1 : f && b > f && (d = !1), d) {
                if (a.disableDates) {
                    if ($.isArray(a.disableDates)) {
                        for (c = 0; c < a.disableDates.length; c += 1) {
