<form class="form-horizontal text-center" action="/action_page.php" id="contact-us-form">
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-6 form-group">
            <input type="date_default_timezone_set" class="form-control customhome" placeholder="Event Date" name="eventdate">
        </div>
    </div>
    <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-6 form-group">
            <select class="form-control customhomeone" placeholder="Type of Event" name="eventtype">
        ...
        <div class="col-md-6 col-sm-6 col-xs-6 form-group">
            <input type="date_default_timezone_set" class="form-control customhome" placeholder="Number of Guests" name="noofguests">
        </div>
    </div>
    <div class="row">
