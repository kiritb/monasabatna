                ...
                <div class="container-fluid" id="customer-profile-bg">
                    <div class="row col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 cust-prof-onlinepy">
                            ...
                            <div class="custpack"> <span class="color-change"><b>Services :</span> Catering, Lighting
                                and Sound</b></div>
                            ...
                            <div class="custpack"><a href="#" class="remunderline"><b>Pending Amount : SAR 604.8</b></a><span
                                    class="dynamic_red"> (To be paid at venue. 16 May,2018 before 11.30 AM)</span></div>
                ...
                <div class="container-fluid" id="customer-profile-bg">
                    <div class="row fullvenue">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 cust-prof-text">
                            ...
                            <a href="#" style="float:right" class="btncancelbyuser" id="myalertcust"><b>Cancelled by
                                    you</b></a>
