            ...
            <div class="col-md-12 col-sm-12 themeform-top">
                ...
                <div class="form-group">
                    <div class="col-md-3 col-sm-3 col-xs-3 form-group packform" id="subpack">
                        <button type="submit" class="btn btn-danger sub_theme">Search</button>
                    </div>
                </div>
            </div>
        </div>
...
<center><h3 class="venuehead"> 121 Search Results </h3></center>
...
<div id="customerprofile">
                  ...
                  <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a class="nav-item nav-link" id="nav-events-tab" data-toggle="tab" href="#nav-events" role="tab" aria-controls="nav-events" aria-selected="false">Packages</a>
                  </div>
                </nav>
  ...
  <div class="form-group">
    <div class="textformat">
      <input class="form-check-input" type="text" value="" id="invalidCheck2" required>
      <label class="form-check-label" for="invalidCheck2">
      Min.
      </label>
      <input class="form-check-input" type="text" value="" id="invalidCheck2" required>
  ...
  <a class="resetvenue" href id="Reset">Clear Filters</a>
  <div class="row"></div>
                        </div>
                    </div><!------- panel end -------->
                    </div><!-------filtersidvenue ---------->
                     ...
                     <div class="row venueslist">
                        ...
                        <div class="row color-bg-venuelist">
                           <div class="content-eve">
                              <img src="svg/images/venues-pic2.jpg" alt="Mountains" style="width:300px; height:273px">
                           </div>
...
<div class="spacer_boxtwo"></div>
                                <div class="wish-text"> <i class='fas fa-map-marker-alt' style='font-size:25px;color:#6cc0b9'></i>&nbsp &nbsp123 XYZ Road, Saudi Arabia</div>
                                <div class="spacer_boxtwo"></div>
                                <div class="wish-text"><b><span class="go-green">Amenities:</span>Gym, Swimming Phool</b></div>
                                <div class="spacer_boxtwo"></div>
                                <div class="wish-text"><b><span class="go-green">Package:</span>Food and Welcome Drinks</b></div>
                                <div class="spacer_boxtwo"></div>
...
**Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
                                 ...
                                 <b><i class="fas fa-users" style="font-size:20px;color:#6cc0b9"></i> 100-200</b></div>
                                 <button class="btn active" id="bn-venuelist" onclick="filterSelection('all')"><b> Book Now</b></button>
                                 
                              </div>
                           </div>
                        </div>
                        <div class="row color-bg-venuelistone">
                           <div class="content-eve">
                              <img src="svg/images/venues-pic3.jpg" alt="Mountains" style="width:300px; height:273px">
                           </div>
...
**Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
                        ...
                        <div class="row color-bg-venuelistone">
                           <div class="content-eve">
                              <img src="svg/images/venues-pic1.jpg" alt="Mountains" style="width:300px; height:273px">
                           </div>
...
**Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
                        ...
                        <div class="row color-bg-venuelistone">
                           <div class="content-eve">
                              <img src="svg/images/venues-pic4.jpg" alt="Mountains" style="width:300px; height:273px">
                           </div>
...
**Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
                        ...
                        <div class="row color-bg-venuelistone">
                           <div class="content-eve">
                              <img src="svg/images/venues-pic5.jpg" alt="Mountains" style="width:300px; height:273px">
                           </div>
