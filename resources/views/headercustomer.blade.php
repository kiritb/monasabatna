...
<nav class="twobutton">
    <div class="float-right">
        <a href class="btn btn-outline-success"><img src="svg/images/photohead"><span class="badge"></span></a>
...
<nav class="navbar bg-white">
    ...
    <navbar>
        <ul>
            ...
            <b><li><a href="#"> EXPRESS </a></li></b>
            <b><li><a href="#"> VENUES</a></li></b>
            <b><li><a href="#">SUPPLIERS </a></li></b>
            <b><li><a href="#"> EVENT ORGANISERS </a></li></b>
            <li class="submenu">
                <b><a href="#">ABOUT US</a></b>
                <ul id="browse">
                <b><li class="abovedrop"><a href="#">About us</a></li></b>
                <b><li class="abovedrop"><a href="#">Why Munasabatna</a></li></b>
                <b><li class="abovedrop"><a href="#">Blogs</a></li></b>
                <b><li class="abovedrop"><a href="#">Contact us</a></li></b>
                </ul>
            </li>
            <b><li><a href="#">CUSTOMER SERVICE </a></li></b>
            <b><li><a href="#"> SHORTLIST</a></li></b>
            <li>
