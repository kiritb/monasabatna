    ...
    <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div>
                        ...
                        <div class="dashboardvenuepart">
                            <table class="table table-xs-12 table-sm-12 table-md-12">
                                ...
                                <tbody class="table-hover">
                                    <tr>
                                        ...
                                        <td class="bg-white-booking"><a data-toggle="modal" data-target="#venueeditpopModal"
                                    ...
                                    <tr>
                                        ...
                                        <td>90 / Day</td>
                                        <td>Non-AC</td>
                                        <td><a data-toggle="modal" data-target="#viewtableModal" class="vadd to eiewamensertable"
                                                href="#">View </a></td>
                                        <td>+616-783437843</td>
                                        <td class="bg-white-booking"><a data-toggle="modal" data-target=".bd-example-modal-xl"
                                                id="mypercent" href="#"><i class="fas fa-eye" style='font-size:20px;color:#66b85d'></i></a></td>
                                ...
                                <div id="paymentdash" class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button data-toggle="modal" id="addexpressbtn" data-target="#updateexpress"
                            ...
                            <!-------------------------------Payment Details ------------------------------------>
                            <div class="modal fade" id="updateexpress" tabindex="-1" role="dialog" aria-labelledby="AddexpressLabel"
                                aria-hidden="true">
                            ...
                            <!------------------Delete Modal ------------------------->
                            <!-------------------------------------Edit venue Modal -------------------------------->
                            <div class="modal fade bd-example-modal-xl" id="venueeditpopModal" tabindex="-1" role="dialog"
                                aria-labelledby="venueeditpopModalLabel" aria-hidden="true">
                                            ...
                                            <form class="form-horizontal" method="post" id="vendor_sign_up_form">
                                                <div class="form">
                                                    <div class="form-group row regfeild">
                                                        <label for="inputEmail3" class="vendorregco">Venue Name :
                                                        </label>
                                                        <div class="col-sm-5">
                                                            <input type="text" name="company_name" class="vendorformreg"
                                                                placeholder=" " value="Shikant">
                                                        </div>
                                                    </div>
                                                    <!------------------form-group row ------------------------->
                                                    <div class="form-group row regfeild">
                                                        <label for="inputEmail3" class="vendorregco">Guest Capacity :
                                                        </label>
                                                        <div class="col-sm-5">
                                                            <input type="text" name="company_name" class="vendorformreg"
                                                                placeholder="200" value="1000">
                                                        </div>
                                                    </div>
                                                    <!------------------form-group row ------------------------->
                                                    <div class="form-group row regfeild">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="text" name="company_name" class="vendorformreg"
                                                                placeholder="200" value="100 SAR / person">
                                                        </div>
                                                    </div>
                                                    <!------------------form-group row ------------------------->
                                                    <div class="form-group row regfeild">
                                                        <label for="inputEmail3" class="vendorregco">Cost Type :
                                                        </label>
                                                        <div class="col-sm-5">
                                                            <input type="text" name="company_name" class="vendorformreg"
                                                    ...
                                                    <!------------------form-group row ------------------------->
                                                    <div class="form-group row regfeild">
                                                        <label for="inputEmail3" class="vendorregco">Start Time :
                                                        </label>
                                                        <div class="col-sm-5">
                                                            <input type="text" name="company_name" class="dashvenuform"
                                                                placeholder="MM:HH" value="12:30 am">
                                                        </div>
                                                    </div>
                                                    <!------------------form-group row ------------------------->
                                                    <div class="form-group row regfeild">
                                                    ...
                                                    <!------------------form-group row ------------------------->
                                                    <div class="form-group row regfeild">
                                                        <label for="inputEmail3" class="vendorregco">Conference Hall
                                                            Provided : </label>
                                                        <div class="marginspacevenue">
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                                    ...
                                                    <!------------------form-group row ------------------------->
                                                    <div class="form-group row regfeild">
                                                        <label for="inputEmail3" class="vendorregco">Event Type :
                                                        </label>
                                                        <div class="marginspacevenue">
                                                            <div class="form-check form-check-inline">
                                                            ...
                                                            <div class="card-header" id="headingTwo">
                                                                <h2 class="mb-0">
                                                                    <button class="btn btn-link collapsed" type="button"
                                                                        ...
                                                                        Sound System <span class="venaccordsn">SAR 100
                                                                            / Person</span>
                                                                    </button>
                                                                </h2>
                                                            </div>
                                                            ...
                                                            <div class="card-header" id="headingThree">
                                                                <h2 class="mb-0">
                                                                    <button class="btn btn-link collapsed" type="button"
                                                                        ...
                                                                        Parking <span class="venaccordpk">SAR 100 /
                                                                            Person</span>
                                                                    </button>
                                                                </h2>
                                                            </div>
                                                    ...
                                                    <!------------------form-group row ------------------------->
                                                    <div class="form-group row regfeild">
                                                        <label for="inputEmail3" class="vendorregco">Amenities :
                                                        </label>
                                                        <div class="marginspacevenue">
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="checkbox" id="inlineCheckbox2"
                                                                    value="option2">
                                                                <label class="form-check-label" for="inlineCheckbox2">Decoration
                                                                    Allowed</label>
                                                            </div>
                                                        </div>
                                                        <!------------marginspacevenue----------------------------->
                                ...
                                <button class="btn addformchk">Add</button>
                                                    ...
                                                    <div class="form-group row regfeild">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="text" name="company_name" class="vendorformvid"
                                                                placeholder="Paste video link here" value="https://www.youtube.com/watch?v=Db9JdS9zmEk">
                                                        </div>
                                                    ...
                                                    <!------------------form-group row ------------------------->
                                                    <div class="form-group row regfeild">
                                                        <label for="inputEmail3" class="vendorregco"> Cancellation
                                                            Charges :</label>
                                                        <div class="col-15">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="text" name="company_name" class="vendorformser"
                                                                placeholder="8%">
                                                        </div>
        ...
        <input class="form-control" type="date" value="" id="startDate" onchange="getStartDate();">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input class="form-control" type="time" value="" id="datetimepicker"
                                                                    onchange="getStartTime(); name:" time" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-----------------timeselector----------------->
                                                    ...
                                                    <div class="form-group row regfeild">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <textarea class="form-control" id="venueeditnote" rows="3"
                                                                value="specify your subscription charges"></textarea>
                                                        </div>
                                                    </div>
                                                    <!------------------form-group row ------------------------->
                                                    <div class="modal-footer">
                                                        <button type="button" id="venuesubmit" class="btn btn-secondary yesamen"
