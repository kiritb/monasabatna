        ...
        <div class="tab-pane fade show active" id="pills-vendorpan" role="tabpanel" aria-labelledby="pills-vendorpan-tab">
            <div class="container-fluid" id="dashboardcontent">
                ...
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <a class="nav-link active" id="v-pills-books-tab" href="{{ url('views/vendor-panel/vendorbookings') }}"
                        role="tab" aria-controls="v-pills-books" aria-selected="true">Bookings</a>
                    <a class="nav-link" id="v-pills-venues-tab" href="{{ url('vendor-panel/vendorvenue') }}" role="tab"
