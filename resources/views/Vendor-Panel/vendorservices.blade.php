                    ...
                    <div>
                        ...
                        <div class="dashboardvenuepart">
                            ...
                            <div class="modal fade" id="serviceeditModal" tabindex="-1" role="dialog" aria-labelledby="serviceeditModalLabel"
                                aria-hidden="true">
                                <div id="serviceeditparent" class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="serviceform">
                                                <form class="form-horizontal" method="post" id="vendor_sign_up_form">
                                                    <div class="form-group row regfeild">
                                                        <label for="inputEmail3" class="vendorregco">Service Name :
                                                        </label>
                                                        <div class="col-sm-5">
                                                            <input type="text" name="company_name" class="vendorformreg"
                                                                placeholder=" " value="Car parking and event">
                                                        </div>
                                                    </div>
                                                    <!------------------form-group row ------------------------->
                                                    <div class="form-group row regfeild">
                                                    ...
                                                    <!------------------form-group row ------------------------->
                                                    <div class="form-group row regfeild">
                                                        <label for="inputEmail3" class="vendorregco">What's Provided :
                                                        </label>
                                                        <div class="col-sm-5">
                                                            <div class="table table-responsive">
                                                                <table class="table table-responsive table-striped table-bordered">
                                                                    <tbody id="TextBoxContent">
                                                                        <tr>
                                                                            <td><input name="DynamicTextBox" type="text"
                                                                                    value="" class="form-control"></td>
                                                                            <td><button type="button" class="btn btn-danger remove"><i
                                                                                        class="far fa-times-circle"></i></i></button></td>
                                                                        </tr>
                                                                    </tbody>
                                                                    <tfoot>
                                                                        <tr>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary yesamen" data-dismiss="modal">Update
                                                    Services</button>
                                                <button type="button" class="btn btn-primary noamen">Cancel</button>
