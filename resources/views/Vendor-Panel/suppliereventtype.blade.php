                ...
                <?php $slno = 1;?>
                 ...
                 <?php  $amentie_id = $amenitie->id?>
                  <tr>
                     ...
                     <td class="bg-white-booking"><a class="amenicon" href="#"><i data-toggle="modal" data-target="#updateAmenities" class="fas fa-pencil-alt editamentieButton" style="font-size:20px;color:#6cc0b9" data-data="{!! $encoded_data !!}"></i></a></td>
                     <td class="bg-white-booking"><a class="amenicon" href="#"><i data-toggle="modal" data-target="#deleteAmenities" class="fas fa-trash-alt deleteamenetie" style="font-size:20px;color:red" data-data="{!! $encoded_data !!}"></i></a></td>
                  </tr>
                 @endforeach
               </tbody>
            </table>
