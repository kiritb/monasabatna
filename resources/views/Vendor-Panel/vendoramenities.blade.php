            ...
            <div class="container-fluid" id="dashboardcontent">
                ...
                <div>
                    <div class="dashvendortop">
                        <a class="amentext" href="#"> Amenities </a>
                        ...
                        <table class="table table-xs-12 table-sm-12 table-md-12">
                            ...
                            <tbody class="table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="bg-white-booking"><a class="amenicon" href="#"><i data-toggle="modal"
                                                data-target="#updateAmenities" class="fas fa-pencil-alt editamentieButton"
                                                style="font-size:20px;color:#6cc0b9" data-data="{!! $encoded_data !!}"></i></a></td>
                                    <td class="bg-white-booking"><a class="amenicon" href="#"><i data-toggle="modal"
                                                data-target="#deleteAmenities" class="fas fa-trash-alt deleteamenetie"
                                                style="font-size:20px;color:red" data-data="{!! $encoded_data !!}"></i></a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group row regfeild">
                                                <label for="inputEmail3" class="vendoramenco">Description : </label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="description" id="short_description" class="vendorformamen"
                                                        placeholder="description">
                                                    <div id="description-error" class="error-class"></div>
                                                </div>
                                            </div>
