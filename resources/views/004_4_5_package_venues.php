                  ...
                  <div class="row">
                           ...
                           <div class="row color-bg-eve">
                              <div class="content-eve">
                                 <img src="<?php echo base_url();?>assets/munasabatna_template/images/portfolio-img1.jpg" alt="Mountains" style="width:300px; height:200px margin-left:10px">
                              </div>
                              ...
                              <div class="card">
                                 ...
                                 <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane active" id="home">
                                       <div class="row color-bg-eve">
                                          <div class="content-eve">
                                             <img src="<?php echo base_url();?>assets/munasabatna_template/images/venues-pic1.jpg" alt="Mountains" style="width:300px; height:200px margin-left:10px">
                                          </div>
                                          <div id="content-eve-right">
                                             <div class="content-option">
                                                <h5><strong>Event Organiser Name</strong><br>
                                       ...
                                       <div class="row color-bg-eve">
                                          <div class="content-eve">
                                             <img src="<?php echo base_url();?>assets/munasabatna_template/images/venues-pic2.jpg" alt="Mountains" style="width:300px; height:200px margin-left:10px">
                                          </div>
                                          <div id="content-eve-right">
                                             <div class="content-option">
                                                <h5><strong>Event Organiser Name</strong><br>
                                       ...
                                       <div class="row color-bg-eve">
                                          <div class="content-eve">
                                             <img src="<?php echo base_url();?>assets/munasabatna_template/images/venues-pic3.jpg" alt="Mountains" style="width:300px; height:200px margin-left:10px">
                                          </div>
                                          <div id="content-eve-right">
                                             <div class="content-option">
                                                <h5><strong>Event Organiser Name</strong><br>
                                       ...
                                       <div class="row color-bg-eve">
                                          <div class="content-eve">
                                             <img src="<?php echo base_url();?>assets/munasabatna_template/images/venues-pic4.jpg" alt="Mountains" style="width:300px; height:200px margin-left:10px">
                                          </div>
                                          <div id="content-eve-right">
                                             <div class="content-option">
                                                <h5><strong>Event Organiser Name</strong><br>
                                       ...
                                       <div class="row color-bg-eve">
                                          <div class="content-eve">
                                             <img src="<?php echo base_url();?>assets/munasabatna_template/images/venues-pic5.jpg" alt="Mountains" style="width:300px; height:200px margin-left:10px">
                                          </div>
                                          <div id="content-eve-right">
                                             <div class="content-option">
                                                <h5><strong>Event Organiser Name</strong><br>
