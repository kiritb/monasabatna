            ...
            <div class="modal fade" id="myFilter">
               <div class="modal-dialog">
                  <div class="modal-content">
                     ...
                     <div class="row content-payment">
                        <div class="form-group">
                           <label class="control-label col-sm-4" id="change-color-popup" for="venuename">Booking ID:</label>
                           <div class="col-sm-6">
                        ...
                        <div class="row"> </div>
                        <div class="form-group">
                           <label class="control-label col-sm-4" id="change-color-popup">Payment Status:</label>
                           <div class="col-sm-6">
                              <select class = "form-control">
                                 <option>205</option>
                                 <option>967</option>
                        ...
                        <div class="row"></div>
                        <div class="form-group">
                           <label class="control-label col-sm-4" id="change-color-popup" for="venuename">Customer Name:</label>
                           <div class="col-sm-6">
                              <input type="text" class="form-control" id="venuename" placeholder="Enter Venue Name" name="venue">
                           </div>
                        </div>
                        <div class="row"> </div>
                        <div class="form-group">
                           <label class="control-label col-sm-4" id="change-color-popup" for="venuename">Mobile:</label>
                           <div class="col-sm-6">
                              <input type="text" class="form-control" id="venuename" placeholder="Enter Venue Name" name="venue">
                           </div>
                        </div>
                        <div class="row"> </div>
                        <div class="form-group">
                           <label class="control-label col-sm-4" id="change-color-popup" for="venuename">Email:</label>
                           <div class="col-sm-6">
                              <input type="text" class="form-control" id="venuename" placeholder="Enter Venue Name" name="venue">
                           </div>
                        </div>
                        <div class="row"> </div>
                        <div class="form-group">
                           <label class="control-label col-sm-4" id="change-color-popup" for="venuename">Arrival Date:</label>
                           <div class="col-sm-6">
                              <input type="text" class="form-control" id="venuename" placeholder="Enter Venue Name" name="venue">
                           </div>
                        </div>
                        <div class="row"> </div>
                        <div class="form-group">
                           <label class="control-label col-sm-4" id="change-color-popup" for="venuename">Departure Date:</label>
                           <div class="col-sm-6">
                              <input type="text" class="form-control" id="venuename" placeholder="Enter Venue Name" name="venue">
                           </div>
                        </div>
                        <div class="row"> </div>
                        <div class="form-group">
                           <label class="control-label col-sm-4" id="change-color-popup" for="venuename">Venue Capacity:</label>
                           <div class="col-sm-6">
                              <input type="text" class="form-control" id="venuename" placeholder="Enter Venue Name" name="venue">
                           </div>
                        </div>
                        <div class="row"> </div>
                        <div class="form-group">
                           <label class="control-label col-sm-4" id="change-color-popup" for="venuename">Expected Guest:</label>
                           <div class="col-sm-6">
                              <input type="text" class="form-control" id="venuename" placeholder="Enter Venue Name" name="venue">
                           </div>
                        </div>
                        <div class="row"> </div>
                        <div class="form-group">
                           <label class="control-label col-sm-4" id="change-color-popup" for="email">Payment Status:</label>
                           <div class="col-sm-6">
                              <select class = "form-control">
                        ...
                        <div class="row"> </div>
                        <div class="form-group">
                           <label class="control-label col-sm-4" id="change-color-popup" for="venuename">Payment Status:</label>
                           <div class="col-sm-6">
                              <input type="text" class="form-control" id="venuename" placeholder="Enter Venue Name" name="venue">
                           </div>
                        </div>
                        <div class="row"> </div>
                        <div class="form-group">
                           <label class="control-label col-sm-4" id="change-color-popup" for="venuename">Payment Type:</label>
                           <div class="col-sm-6">
                              <input type="text" class="form-control" id="venuename" placeholder="Enter Venue Name" name="venue">
                           </div>
                        </div>
