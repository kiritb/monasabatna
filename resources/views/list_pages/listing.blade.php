                    ...
                    <div id="customerprofile">
                        <nav>
                            <div class="nav nav-tabs d-flex" id="nav-tab" role="tablist">
                                ...
                                <a class="nav-item nav-link list-nav-tabs" id="nav-package-eveorgs-tab" data-toggle="tab"
                                    href="#nav-package-eveorgs" role="tab" aria-controls="nav-profile" aria-selected="false">Event
                                    Organisers</a>
                                <a class="nav-item nav-link list-nav-tabs" id="nav-package-suppliers-tab" data-toggle="tab"
                                    href="#nav-package-suppliers" role="tab" aria-controls="nav-contact" aria-selected="false">Suppliers</a>
                            </div>
                        </nav>
                                        ...
                                        <div class="row rightevent">
                                            ...
                                            <div class="container-fluid" id="underlinetab">
                                                ...
                                                <div class="tab-content" id="pills-tabContent">
                                                    ...
                                                    <div class="row tab-pane fade" id="express-suppliers" role="tabpanel"
