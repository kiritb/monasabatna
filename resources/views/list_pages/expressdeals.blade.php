...
<div class="container-fluid" id="customerdetails">
    ...
    <!--- event right ---------------------->
    <div class="container-fluid" id="expressListingPage">
        <div class="row rightevent">
            ...
            <div class="container-fluid underlinetab">
                <ul class="nav nav-pills col-sm-10 tab-data mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="express-venues-tab" data-toggle="pill" href="#express-venues"
                            role="tab" aria-controls="express-venues" aria-selected="true"
                            onclick="getTypeListItems('express-venues')">Venues</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="express-events-tab" data-toggle="pill" href="#express-events" role="tab"
                            aria-controls="express-events" aria-selected="false"
                            onclick="getTypeListItems('express-events')">
                            Event Organisers
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="express-suppliers-tab" data-toggle="pill" href="#express-suppliers"
                            role="tab" aria-controls="express-suppliers" aria-selected="false"
                            onclick="getTypeListItems('express-suppliers')">
                            Suppliers
                        </a>
                    </li>
                ...
                <div class="tab-content" id="express-deals-tabContent">
                    <div class="tab-pane show active" id="express-venues" role="tabpanel"
                    ...
                    <div class="tab-pane fade" id="express-suppliers" role="tabpanel"
