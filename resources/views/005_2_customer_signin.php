...
<body>
         ...
         <div class="row bg-custsignin">
			  ...
			  <form class="form-horizontal" method="post" id="sign_up_form" enctype="multipart/form-data">
					   ...
					   <div class="row">
						...
						<label class="control-label col-sm-11 formcust-signin" for="personname">Password</label>
						   ...
						   <label class="control-label small-cust" for="personname"><a href="">Forgot Password?</a></label>
						...
						<div class="col-md-12">
						 ...
						 <button class="signinbutton" href="#signin"> Sign In</a></button>
						...
						<div class="col-sm-12">
						   ...
						   <label class="control-label small-cust" for="personname">New User?<a href="http://brillmindz.org/monasabatna/Html_dummy_pages/customer_signup">&nbsp;Sign Up</a></label>
			...
			<img src="<?php echo base_url();?>assets/munasabatna_template/images/cust-signin.jpg" class="img-responsive">
