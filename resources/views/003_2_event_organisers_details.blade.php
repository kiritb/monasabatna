...
<body>
    ...
    <div class="container-fluid">
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <a class="carousel-control left" id="detail-banner-left" href="#myCarousel" data-slide="prev">
                <</a> <a class="carousel-control right" id="detail-banner-right" href="#myCarousel" data-slide="next">>
            </a>
        </div>
    </div>
    <!------- Banner end-------->
    <div class="container">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="row arrange-supplier">
                ...
                <h6><i class="fa fa-map-marker" style="font-size:20px;" aria-hidden="true"></i>Address:<b>123 XYZ
                        Road,Saudi Arabia </b><a href="">Show in map</a>
                    <br>Travel free upto 10 kms. SAR 50 for 11 kms.</h6>

                <h6><i class="material-icons" style="font-size:20px">collections_bookmark</i>Customer Service Number:<b>+85-9876543210
                    </b></h6>

                <h6><i class="material-icons" style="font-size:20px;">filter_b_and_w</i>
                    <h6>License Number:<b>123 XYZ Road,Saudi Arabia </b></h6>
        ...
        <div class="bg-star">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-xs-612">
                    <h4 class="eve-head">
                        <bold>
                            <center> See What our Customers are saying
                        </bold>
                        <center>
                    </h4>
                </div>
            ...
            <div id="myvenuedetail" class="carousel slide">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="item active">
                        ...
                        <div class="row-fluid">
                            <div class="flex-venue-details"><a class="thumbnail"><img src="svg/images/event-thumbnail-one.jpg"
                                        alt="Image" class="img-responsive" /></a>
                                <h5><b> Hotel XYZ</b> </h5>
                            </div>
                            <div class="flex-venue-details"><a class="thumbnail"><img src="svg/images/event-thumbnail-two.jpg"
                                        alt="Image" class="img-responsive" /></a>
                                <h5><b> Hotel XYZ</b> </h5>
                            </div>
                            <div class="flex-venue-details"><a class="thumbnail"><img src="svg/images/event-thumbnail-three.jpg"
                                        alt="Image" class="img-responsive" /></a>
                                <h5><b> Hotel XYZ</b> </h5>
                            </div>
                            <div class="flex-venue-details"><a class="thumbnail"><img src="svg/images/event-thumbnail-four.jpg"
                                        alt="Image" class="img-responsive" /></a>
                                <h5><b> Hotel XYZ</b> </h5>
                            </div>
                            <div class="flex-venue-details"><a class="thumbnail"><img src="svg/images/event-thumbnail-five.jpg"
                                        alt="Image" class="img-responsive" /></a>
                                <h5><b> Hotel XYZ</b> </h5>
                            </div>
                        </div>
