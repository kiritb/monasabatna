            ...
            <div id="customerprofile">
                <nav>
                    <div class="nav nav-tabs d-flex" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link list-nav-tabs active" id="nav-home-tab" data-toggle="tab" href="#nav-home"
                            role="tab" aria-controls="nav-home" aria-selected="true">Venue</a>
                        <a class="nav-item nav-link list-nav-tabs" id="nav-profile-tab" data-toggle="tab" href="#nav-profile"
                            role="tab" aria-controls="nav-profile" aria-selected="false">Suppliers</a>
                        <a class="nav-item nav-link list-nav-tabs" id="nav-contact-tab" data-toggle="tab" href="#nav-contact"
                            role="tab" aria-controls="nav-contact" aria-selected="false">Event Organisers<span class="badge">
                                2</span></a>
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        ...
                        <div class="container-fluid" id="customer-cancel-bg">
                            ...
                            <div class="row canceltwo"> ** Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                                do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                                quis nostrud exercitation ullamco laboris nisi ut aliquip.Lorem ipsum dolor sit amet,
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="exampleFormControlTextarea1" placeholder="Please let us know the reason for cancelling..."
                                    rows="5"></textarea>
                                <center> <button style="float:center" type="submit" class="btn btn-lg confcancel">Confirm
                                        Cancellation</button>
                                    <center>
                            </div>
            ...
            <div id="bookinghistorysection">
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="bookorg" role="tabpanel" aria-labelledby="bookorg-tab">
                        <div class="row organisers"> <span class="org-head"><b>Your following request has been
                                    confirmed by the Event Organiser. You can book now.</span></b>
                            <div class="container-fluid" id="customer-profile-bg">
                                <div class="row col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                              ...
                              Booking Date : July 8, 2018
                                        ...
                                        <address>
                                            <div class="icons-cust"><i class="fas fa-map-marker-alt" style="font-size:22px; color:#6cc0b9"></i></div>
                                            <div class="marginevent">Address:<b> 123 XYZRoad, Saudi Arabia </b><a href="#">
                                                    Show in map</a></div>
                                        </address>
                                        <datetime>
                                            <div class="icons-custone"><i class="fas fa-clipboard-list" style='font-size:19px; color:#6cc0b9'></i></div>
                                            <div class="marginevent">From:<b> July 16,2018<span class="spaceone">11:30
                                                        AM</span></b>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; To:<b>July
                                        ...
                                        <button style="float:right" type="submit" class="btn btn-default btnevents">Book
                                            Now</button>
