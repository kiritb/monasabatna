...
------>
  ...
  <li class="nav-item">
    <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true"><b>My Bookings</b></a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false"><b>Booking History</b></a>
  </li>
</ul>
<div class="tab-content" id="pills-tabContent">
                  ...
                  <div class="row col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     ...
                     <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 cust-prof-onlinepy">
                        ...
                        <div class="custpack"> <span class="color-change"><b>Total Price :</span> SAR.756</b></div>
                                ...
                                <div class="container-fluid" id="customer-cancel-bg">
                                    <div class="row cancelone"><a href="#">Cancellation Policy</a> </div>
                                    <div class="row canceltwo"> ** Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea1" placeholder="Please let us know the reason for cancelling..." rows="5"></textarea>
                                       <center> <button style="float:center" type="submit" class="btn btn-lg confcancel">Confirm Cancellation</button><center>
                                    </div>
  ...
  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab"> <!---- customer_profile_paying_cash ------>
                  <div id="bookinghistorysection">
                     ...
                     <li class="nav-item">
                        <a class="nav-link active" id="bookvenue-tab" data-toggle="tab" href="#bookvenue" role="tab" aria-controls="bookvenue" aria-selected="true">Venues</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" id="booksupp-tab" data-toggle="tab" href="#booksupp" role="tab" aria-controls="booksupp" aria-selected="false">Suppliers</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" id="bookorg-tab" data-toggle="tab" href="#bookorg" role="tab" aria-controls="bookorg" aria-selected="false">Event Organisers <span class="badge">  2</span></a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" id="bookevent-tab" data-toggle="tab" href="#bookevent" role="tab" aria-controls="bookevent" aria-selected="false">Events</a>
                     </li>
                     </ul>
                  ...
                  <div class="row col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     ...
                     <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 cust-prof-onlinepy">
                        ...
                        <button style="float:right" type="submit" class="btn btn-default btnvenueflex">Write a Review</button>
                  ...
                  <div class="row col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     ...
                     <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 cust-prof-onlinepy">
                        ...
                        <address><div class="icons-cust"><i class="fas fa-map-marker-alt" style="font-size:22px; color:#6cc0b9"></i></div><div class="margincst">Address:<b> 123 XYZRoad, Saudi Arabia </b><a href="#">  Show in map</a></div></address>
                        <datetime><div class="icons-custone"><i class="fas fa-clipboard-list" style='font-size:19px; color:#6cc0b9'></i></div><div class="margincst">From:<b> July 16,2018<span class="spaceone">11:30 AM</span></b>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;       To:<b>July 16,2018<span class="spaceone"> 11:30 AM</span></b></div></datetime>
                        <div class="spacer_boxthree"></div>
                        
                        <div class="custpack"> <span class="color-change"><b>Item Supplied Date :</span> May 16,2018</b></div>
                        <div class="spacer_boxthree"></div>
                        <div class="custpack"> <span class="color-change"><b>Attached Event Organiser :</span>Event Organiser Name</b></div>
                        <div class="spacer_boxthree"></div>
                        <div class="custpack"> <span class="color-change"><b>Attached Venue :</span> Venue Name</b></div>
                        <div class="spacer_boxthree"></div>
                  ...
                  <div class="row col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     ...
                     <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 cust-prof-onlinepy">
                        <div class="row custprofhead">
                           ...
                           <h4 class="go-supplierone" style="float:right">Booking Number : MTNA0789456<br><div class="spacer_box"></div>
                              Booking Date : July 8, 2018
                           </h4>
                        </div>
                        <div class="packoffer"><b>Package : Desserts, Chocolates and Cakes </b></div>
                  ...
                  <!------------------ end of event content -------------->
                     ...
                     <div class="row organisers"> <span class="org-head"><b>Your following request has been confirmed by the Event Organiser. You can book now.</span></b>
                  <div class="container-fluid" id="customer-profile-bg">
                  <div class="row col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                        <img src="svg/images/custprof-eventorganisers-pic.jpg" alt="Mountains" style="width:300px; height:300px; margin-left:-62px; margin-top:0px">
                     </div>
                     <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 cust-prof-onlinepy">
                        <div class="row custprofhead">
                           <h3 class="cust-head"><b>Party Zone</b></h3>
                        ...
                        <address><div class="icons-cust"><i class="fas fa-map-marker-alt" style="font-size:22px; color:#6cc0b9"></i></div><div class="marginevent">Address:<b> 123 XYZRoad, Saudi Arabia </b><a href="#">  Show in map</a></div></address>
                        <datetime><div class="icons-custone"><i class="fas fa-clipboard-list" style='font-size:19px; color:#6cc0b9'></i></div><div class="marginevent">From:<b> July 16,2018<span class="spaceone">11:30 AM</span></b>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;       To:<b>July 16,2018<span class="spaceone"> 11:30 AM</span></b></div></datetime>
                        <div class="spacer_boxthree"></div>
                        ...
                        <button style="float:right" type="submit" class="btn btn-default btnevents">Book Now</button>
                  ...
                  <div class="row col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     ...
                     <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 cust-prof-onlinepy">
                        ...
                        <button style="float:right" type="submit" class="btn btn-default btnevents">Write a Review</button>
                  ...
                  <!------------end of events content ---------------------->     
                     ...
                     <div class="tab-pane fade" id="bookevent" role="tabpanel" aria-labelledby="bookevent-tab">
                     
                     <div class="container-fluid" id="booking-history-bg"><!----- star of event page --------->
                  <div class="row col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                        <img src="svg/images/customer-profile11.jpg" alt="Mountains" style="width:300px; height:300px; margin-left:-62px; margin-top:0px">
                     </div>
                     <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 cust-prof-onlinepy">
                        ...
                        <button style="float:right" type="submit" class="btn btn-default btnbkevents">Write a Review</button>
...
</div><!--------- closure offour tabs ------------>
</div><!---------- closure of two tabs ------------>
</div>
