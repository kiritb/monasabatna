    ...
    <div class="container-fluid" id="commonpack-bg">
        <div class="row" id="set-bg">
            <div class="col-md-12 col-sm-12 themeform-top">
                ...
                <div class="col-md-2 col-sm-3 col-xs-3 form-group packform" id="supppackdet">
...
<div class="container-fluid" id="supplierpacksect">
    ...
    <div class="row supptravel">Travel free upto 10 kms. SAR 50 for 11kms. to 25 kms </div>
