...
<style type="text/css">
 ...
 <!------- body start-------->   
  ...
  <div class="form-group" id="formforgot">
    <label id="forgotlab" for="inputAddress">Enter OTP</label>
    <input type="text" class="form-control" id="inputforgot" placeholder="Please enter OTP">
  </div>
 
  <button type="submit" class="forgotsubmit">Submit</button>
  <div class="row forgotbaselink"><a href="#">Resend OTP </a></div>
