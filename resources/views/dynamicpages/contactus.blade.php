    ...
    <div class="rightcontact">
        ...
        <form class="form-horizontal" id="contact-us-form">
            <div class="form-group">
                ...
                <input type="firstname" name="first_name" class="form-control" id="exampleInputfname" aria-describedby="emailHelp"
                    placeholder="First Name">
            </div>
            <div class="form-group">
                <input type="secondname" name="fathers_name" class="form-control" id="exampleInputsname" placeholder="Second Name">
            </div>
            <div class="form-group">
                <input type="familyname" name="family_name" class="form-control" id="exampleInputfamname" placeholder="Family Name">
            </div>
