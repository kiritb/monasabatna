                ...
                <div class="booking">
                    ...
                    <div class="booking-body">
                        ...
                        <div class="row infolog">
                            ...
                            <div class="col-25">
                                <input type="text" readonly class="form-control-plaintext" id="fname" name="firstname"
                                    style="border:none" value="5 Days 4 Nights">
                            </div>
                        </div>
                        <!---- row infolog------------>
                        <div class="row infolog">
                        ...
                        <div class="row infolog">
                            ...
                            <div class="col-25">
                                <input type="text" readonly class="form-control-plaintext" id="fname" name="firstname"
                                    style="border:none" value="Catering, Lighting and Sound">
                            </div>
                        </div>
                        <!---- row infolog------------>
                        <div class="row infolog">
                            ...
                            <div class="col-25">
                                <input type="text" readonly class="form-control-plaintext" id="fname" name="firstname"
                                    style="border:none" value="May 16,2018     11:30 AM">
                            </div>
                        </div>
                        <!---- row infolog------------>
                        <div class="row infolog">
                            ...
                            <div class="col-25">
                                <input type="text" readonly class="form-control-plaintext" id="fname" name="firstname"
                                    style="border:none" value="May 20,2018     11:30 AM"">
      </div>
    </div><!---- row infolog------------>
    </div>
    <div class="
                                    pytconf-footer"><span class="coltext">Total Price: </span>SAR.756</div>
                    ...
                    <div class="container-fluid" id="codeconftext">
                        Please give the code '<span class="pakcolor">MS1234</span>' at Venue while making the remaining
                        payment.
                    </div>
                    <!--------------bkconftext ------------------->
                    <div class="container-fluid" id="bkconftext">
                        ...
                        laboris nisi ut aliquip.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
