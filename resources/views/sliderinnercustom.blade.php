...
<div id="myCarouselIndicators" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block" src="svg/images/theme-banner1.jpg" alt="First slide">
        ...
        <div class="carousel-item">
            <img class="d-block" src="svg/images/theme-banner2.jpg" alt="Second slide">
            <div class="carousel-caption home-banner-captions">
                <h1 class="bannerfont">
        ...
        <div class="carousel-item">
            <img class="d-block" src="svg/images/theme-banner3.jpg" alt="Third slide">
            <div class="carousel-caption home-banner-captions">
                <h1 class="bannerfont">
