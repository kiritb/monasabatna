			...
			<div class="col-md-4 col-sm-4 col-xs-4 form_custsignup">
			  ...
			  <form class="form-horizontal" method="post" id="sign_up_form" enctype="multipart/form-data">
					   ...
					   <div class="row">
                        ...
                        <div class="col-sm-2">
                           <input type="text" class="form-control" id="phone_number_custsignup" placeholder="Enter Phone Number" name="phone_number">
                        </div>
						...
						<label class="control-label col-sm-11 formcust-signin" for="personname">Confirm Password</label>
						...
						<div class="form-group">
                           ...
                           <div class="small-custup">
                              ...
                              <label><input type="checkbox" name="terms_and_conditions"></label>
				<span class="check-customised">I Agreed to Munasabatna<a href="#">Terms & &nbsp; Conditions</a> and <a href="#">Privacy Policies</a></span>
						...
						<div class="col-md-12">
						 ...
						 <button class="signinbutton"><a id="myOTP" class="coltext"  href="#signin"> Register</a></button>
                        </div>

						<div class="col-sm-12">

						   <label class="control-label small-custupreg" for="personname">Already have an account?<a href="http://brillmindz.org/monasabatna/Html_dummy_pages/customer_signin">&nbsp;Sign In</a></label>
