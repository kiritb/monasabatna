...
class BlogController extends Controller
{
    ...
    public function getBlogs()
    {
        ...
        try {
                ...
                return response( ResponseUtil::buildSuccessResponse($blogsData), HttpStatusCodesConsts::HTTP_OK );
        }
        catch( \Exception $e)
        {
    ...
    public function postReviews(Request $request)
    {
        ...
        if(empty($userData))
        {
            ...
            $responseArr = ResponseUtil::buildErrorResponse(['errors' => ['User Not Found']], HttpStatusCodesConsts::HTTP_BAD_REQUEST, 'UserNotFound');
        ...
        try {   
                ...
                BlogHelper::postReviews( $requestParams );

                return response(ResponseUtil::buildSuccessResponse(['message' =>'Successfully created a Review']), HttpStatusCodesConsts::HTTP_CREATED);
